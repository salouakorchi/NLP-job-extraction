...
| competences_techniques | 0 | 0 | 0 | 1 | 0 | 0 |
...
|---|---:|
| correct | 8 |
| extraction_partielle | 3 |
| valeur_incorrecte | 1 |

## Top 5 exemples les plus difficiles

- ID 1 : 4 erreurs, categories {'extraction_partielle': 3, 'valeur_incorrecte': 1}
